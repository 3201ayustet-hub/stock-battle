(() => {
  ...
  function renderSaved() {
    ...
    document.getElementById('saved-section').classList.toggle('hidden', items.length === 0);
  ...
  async function init() {
    ...
    renderSaved(); renderPlayers(); form.classList.remove('hidden'); form.start_date.value = SB.today();
    if (SB.token) {
      try {
